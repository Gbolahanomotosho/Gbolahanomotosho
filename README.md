...
|--------|----------------------|
| **🔒 Cybersecurity** | Network Security, Ethical Hacking, Cryptography, Digital Forensics, Vulnerability Assessment |
| **💻 Software Development** | Python, JavaScript, SQL, API Integration, Full-Stack Web Development |
| **🧠 AI & Machine Learning** | Computer Vision (YOLO, PyTorch), LLM Integration, Voice Recognition (Whisper), OCR |
...
| **[Gem](https://github.com/Gbolahanomotosho/Gem)** | AI-powered educational assistant with multi-provider routing | Flask, Multi-AI API, SQLite |

---

## 📊 GitHub Stats

![Your GitHub stats](https://github-readme-stats.vercel.app/api?username=Gbolahanomotosho&show_icons=true&theme=dark)

![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Gbolahanomotosho&layout=compact&theme=dark)
